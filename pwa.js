...
const cacheName = 'LAWK7GabiKeaton-2021-10-22 18:23:56.647291'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWK7GabiKeaton'.length) === 'LAWK7GabiKeaton') {
